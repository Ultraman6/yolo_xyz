...
def test_export_torchscript():
    """Test YOLO_xyz model exporting to TorchScript format for compatibility and correctness."""
    file = YOLO(MODEL).export(format="torchscript", optimize=False, imgsz=32)
    YOLO(file)(SOURCE, imgsz=32)  # exported model inference


def test_export_onnx():
    """Test YOLO_xyz model export to ONNX format with dynamic axes."""
...
def test_export_openvino():
    """Test YOLO_xyz exports to OpenVINO format for model inference compatibility."""
...
def test_export_openvino_matrix(task, dynamic, int8, half, batch):
    """Test YOLO_xyz model exports to OpenVINO under various configuration matrix conditions."""
...
def test_export_onnx_matrix(task, dynamic, int8, half, batch, simplify):
    """Test YOLO_xyz exports to ONNX format with various configurations and parameters."""
    file = YOLO(TASK2MODEL[task]).export(
        format="onnx",
        imgsz=32,
        dynamic=dynamic,
...
def test_export_torchscript_matrix(task, dynamic, int8, half, batch):
    """Tests YOLO_xyz model exports to TorchScript format under varied configurations."""
    file = YOLO(TASK2MODEL[task]).export(
        format="torchscript",
        imgsz=32,
        dynamic=dynamic,
...
def test_export_coreml_matrix(task, dynamic, int8, half, batch):
    """Test YOLO_xyz exports to CoreML format with various parameter configurations."""
    file = YOLO(TASK2MODEL[task]).export(
        format="coreml",
        imgsz=32,
        dynamic=dynamic,
...
def test_export_tflite_matrix(task, dynamic, int8, half, batch):
    """Test YOLO_xyz exports to TFLite format considering various export configurations."""
    file = YOLO(TASK2MODEL[task]).export(
        format="tflite",
        imgsz=32,
        dynamic=dynamic,
...
def test_export_coreml():
    """Test YOLO_xyz exports to CoreML format, optimized for macOS only."""
    if MACOS:
...
def test_export_tflite():
    """Test YOLO_xyz exports to TFLite format under specific OS and Python version conditions."""
    model = YOLO(MODEL)
...
def test_export_pb():
    """Test YOLO_xyz exports to TensorFlow's Protobuf (*.pb) format."""
    model = YOLO(MODEL)
...
def test_export_paddle():
    """Test YOLO_xyz exports to Paddle format, noting protobuf conflicts with ONNX."""
    YOLO(MODEL).export(format="paddle", imgsz=32)


@pytest.mark.slow
def test_export_ncnn():
    """Test YOLO_xyz exports to NCNN format."""
