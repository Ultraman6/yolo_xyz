...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        """Applies the YOLO_xyz FPN to input data."""
...
class C2fAttn(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, ec=128, nh=1, gc=512, shortcut=False, g=1, e=0.5):
        ...
        super().__init__()
        # print(c1, c2, n, ec, nh, gc, shortcut, g, e)
        self.c = int(c2 * e)  # hidden channels
        self.cv1 = Conv(c1, 2 * self.c, 1, 1)
...
class BNContrastiveHead(nn.Module):
    """
    Batch Norm Contrastive Head for YOLO_xyz-World using batch norm instead of l2-normalization.
...
class C2fCIBAttn(nn.Module):  # gc、e、lk均为常量，且 原始bottleneck的g省略
    def __init__(self, c1, c2, n=1, ec=128, nh=1, shortcut=False, lk=False, e=0.5, gc=512):
