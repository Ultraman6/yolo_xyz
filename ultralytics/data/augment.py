...
class MixUp(BaseMixTransform):
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        values and labels. This implementation is designed for use with the Ultralytics YOLO_xyz framework.
...
class Albumentations:
    ...
    def __init__(self, p=1.0):
        """
        Initialize the Albumentations transform object for YOLO_xyz bbox formatted parameters.
...
class Format:
    ...
    def _format_img(self, img):
        """
        Formats an image for YOLO_xyz from a Numpy array to a PyTorch tensor.
...
class ToTensor:
    ...
    def __init__(self, half=False):
        ...
        Ultralytics YOLO_xyz framework. It converts numpy arrays or PIL Images to PyTorch tensors, with an option
