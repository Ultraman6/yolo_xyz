...
class NASPredictor(BasePredictor):
    """
    Ultralytics YOLO_xyz NAS Predictor for object detection.

    This class extends the `BasePredictor` from Ultralytics engine and is responsible for post-processing the
    raw predictions generated by the YOLO_xyz NAS models. It applies operations like non-maximum suppression and
