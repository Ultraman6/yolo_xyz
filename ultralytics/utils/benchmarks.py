...
"""
Benchmark a YOLO_xyz model formats for speed and accuracy.
...
def benchmark(
    ...
    """
    Benchmark a YOLO_xyz model across different formats for speed and accuracy.
...
class RF100Benchmark:
    """Benchmark YOLO_xyz model performance across formats for speed and accuracy."""
